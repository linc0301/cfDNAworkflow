...
for key,value in sorted(kmerFrequencyLEp.items()):
  outfile.write("%s\t%s\n"%(key,value))
outfile.close()
outfile = open(options.outfileLE+"_r.tsv","w")
for key,value in sorted(kmerFrequencyLEm.items()):
  outfile.write("%s\t%s\n"%(key,value))
outfile.close()

outfile = open(options.outfileRE+"_f.tsv","w")
for key,value in sorted(kmerFrequencyREp.items()):
  outfile.write("%s\t%s\n"%(key,value))
outfile.close()
outfile = open(options.outfileRE+"_r.tsv","w")
for key,value in sorted(kmerFrequencyREm.items()):
  outfile.write("%s\t%s\n"%(key,value))
outfile.close()